...
<div id="result">
	<table id="user_view">
		<?php
		if($my_info->num_rows() == 0)
		{
			echo '<li class="img_title">no user found</li>';
		}
		else
		{
			foreach($my_info->result() as $row):
				echo '<tr>';
				echo '<td>Fullname :</td>';
				echo '<td  style="color: #000;"><h4>'.$row->first_name.'&nbsp;&nbsp'.$row->last_name.'</h4></td>';
				echo '</tr>';
				echo '<tr>';
				echo '<td>Username :</td>';
				echo '<td  style="color: #000;">'.$row->username.'</td>';
				echo '</tr>';
				echo '<tr>';
				echo '<td>Email Address :</td>';
				echo '<td  style="color: #000;">'.$row->email_address.'</td>';
				echo '</tr>';
				echo '<td>Total Encoded :</td>';
				echo '<td  style="color: #000;"><h4>'.$count->num_rows().'</h4></td>';
			endforeach;
		}
		?>
	</table>
